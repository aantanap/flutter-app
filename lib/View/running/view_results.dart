// ignore_for_file: avoid_function_literals_in_foreach_calls, deprecated_member_use, unused_field, unused_local_variable, prefer_interpolation_to_compose_strings, avoid_print, duplicate_ignore, prefer_const_constructors, unused_import, duplicate_import, prefer_typing_uninitialized_variables, unused_element, prefer_const_literals_to_create_immutables, non_constant_identifier_names, prefer_final_fields, use_build_context_synchronously
    ...
    return Expanded(
      child: ListView(
          ...
          children: [
            Column(
              children: [
                Text("ระยะทาง,ขนาดเสื้อและที่อยู่จัดส่ง",
                    style: Theme.of(context).textTheme.bodyText2!.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        )),
